...
&= argmin_\beta ||\begin{pmatrix}\overrightarrow{Y}\\ 0 \end{pmatrix} - \begin{pmatrix}X\overrightarrow{\beta}\\ -\sqrt{\lambda\alpha} \end{pmatrix}||_2^2 + \lambda(1-\alpha)||\overrightarrow{\beta}||_1\\
